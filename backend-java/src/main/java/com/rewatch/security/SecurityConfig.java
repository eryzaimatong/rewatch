    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // The OG link-preview image for /social/:userId and /compare/:username
                // is generated by a Vercel edge function on a crawler's behalf, which
                // has no user login at all — see SocialController's og-summary
                // endpoints and SocialService.publicOgSummary for what's actually
                // exposed (never the full authenticated profile payload).
                .requestMatchers(HttpMethod.GET, "/api/social/*/og-summary",
                        "/api/social/username/*/og-summary")
                    .permitAll()
